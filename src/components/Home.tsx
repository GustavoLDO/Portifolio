...
function Home() {
    return (
        ...
        <div id="home" className="flex flex-col w-full bg-transparent text-white overflow-x-hidden font-outfit">
            <NavBar />
            ...
            <section id="sobre" className="relative z-10 bg-black/20 backdrop-blur-[2px] py-10 scroll-mt-20">
                <Sobre />
            </section>
            ...
            <section id="projetos" className="relative py-32 bg-transparent scroll-mt-20">
            ...
            <section id="contatos" className="relative py-24 backdrop-blur-md overflow-hidden scroll-mt-20">
