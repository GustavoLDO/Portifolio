...
function Sobre() {
	return (
		<section
			id="sobre"
			className="relative w-full max-w-7xl mx-auto py-16 md:py-24 px-4 sm:px-6 lg:px-8 font-outfit overflow-hidden"
		>
				...
				<div className="lg:col-span-7 space-y-8 md:space-y-12 order-2 lg:order-1">
					...
					<div className="space-y-6 md:space-y-8 text-lg sm:text-xl md:text-2xl text-gray-300 leading-relaxed font-normal">
						<p>
							...
							eficientes, sem abrir mão de interfaces de alto nível e
							performance.
						</p>
						<p>
							Minha trajetória é impulsionada pela curiosidade técnica e pelo
							desafio de solucionar problemas complexos através do código.
							Especializo-me em arquitetar sistemas que sejam{" "}
							<span className="text-cyan-400 font-semibold">
								altamente escaláveis
							</span>
							, <span className="text-purple-400 font-semibold">seguros</span> e{" "}
							<span className="text-white font-semibold">
								focados na melhor experiência do usuário
							</span>
							.
						</p>
						<p className="text-base md:text-xl text-gray-400 italic">
							Atualmente, especializo-me em ecossistemas modernos como{" "}
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 pt-4">
						...
						<div className="p-6 rounded-2xl bg-zinc-900/60 border border-zinc-800 hover:border-white/30 transition-all group sm:col-span-2 md:col-span-1">
							...
							<p className="text-sm md:text-base text-zinc-400 group-hover:text-zinc-300 transition-colors">
								Manutenibilidade e clareza absoluta.
							</p>
						</div>
					</div>
				</div>
					...
					<div className="relative bg-zinc-900/50 backdrop-blur-xl border border-white/10 rounded-[1.5rem] md:rounded-[2rem] p-6 md:p-10 overflow-hidden shadow-2xl">
						...
						<ul className="space-y-6 md:space-y-8">
							{[
								...
								{ label: "Interesses", value: "Back-End e Data Base Analysis" },
							].map((item, index) => (
