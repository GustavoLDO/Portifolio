...
const tecs = [
    ...
    { icon: SiMongodb, nome: "MongoDB", categoria: "Intermediário", cor: "cyan" },
    { icon: SiRedis, nome: "Redis", categoria: "Intermediário", cor: "cyan" },
    { icon: SiOracle, nome: "Oracle", categoria: "Avançado", cor: "purple" },
    { icon: SiPhp, nome: "PHP", categoria: "Intermediário", cor: "cyan" },
    { icon: SiLaravel, nome: "Laravel", categoria: "Intermediário", cor: "cyan" },
];
